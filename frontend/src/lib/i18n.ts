...
const en: Dict = {
  ...
  "analyzer.setupSelectHint": "Select a trade to draw OB / liquidity / SCM.",
  "analyzer.setupOverlayHint": "Shaded OB zone · Liq dashed · SL/TP on axis · select one trade",
  "analyzer.setupTitle": "SMC setup (engine)",
  "analyzer.setupBuyLiq": "Buy-side liquidity taken",
  "analyzer.setupSellLiq": "Sell-side liquidity taken",
  ...
  "sticky.boardMlHint": "Maylels setup diagrams (ML01 ChoCh+BOS · ML02 Single Candle Mitigation).",
...
const es: Dict = {
  ...
  "analyzer.setupSelectHint": "Elige un trade para dibujar OB / liquidez / SCM.",
  "analyzer.setupOverlayHint": "Zona OB sombreada · Liq punteada · SL/TP en el eje · elige un trade",
  "analyzer.setupTitle": "Setup SMC (motor)",
  "analyzer.setupBuyLiq": "Liquidez buy-side tomada",
  "analyzer.setupSellLiq": "Liquidez sell-side tomada",
  ...
  "sticky.boardMlHint": "Diagramas Maylels (ML01 ChoCh+BOS · ML02 Single Candle Mitigation).",
