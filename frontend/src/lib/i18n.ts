...
const en: Dict = {
  ...
  "jobs.hint": "Candle archive into Dynamo — status, history, manual runs.",
  "jobs.blurb":
    "Nightly EOD fills gaps (15m · 1h · 4h · 1m). Backfill pulls max Yahoo history (~59d of 15m). Archive grows every night — Analyzer reads Dynamo.",
  "jobs.scheduleTitle": "When jobs run",
  "jobs.scheduleEod":
    "EOD (auto): every night at 02:15 UTC ≈ 22:15 ET on staging SAM. Local has no cron — use “Run EOD now”.",
  "jobs.scheduleBackfill":
    "Backfill: manual only (button). Caps at Yahoo limits (~59 days of 15m).",
  "jobs.runEod": "Run EOD now",
  "jobs.runBackfill": "Run backfill (max Yahoo)",
  "jobs.refresh": "Refresh",
  "jobs.runningEod": "Running EOD archive…",
  "jobs.runningBackfill": "Running Yahoo backfill (may take a few minutes)…",
  "jobs.done": "Done",
  "jobs.acceptedBg": "Started in background — refresh in 1–2 minutes.",
  "jobs.loading": "Loading…",
  "jobs.scheduled": "Job cards",
  "jobs.scheduledHint": "Last run per job · schedule reminder",
  "jobs.scheduleLabel": "Schedule",
  "jobs.scheduleEt": "ET",
  "jobs.scheduleUtc": "UTC",
  "jobs.lastRun": "Last",
  "jobs.neverRun": "Never run yet — use Backfill or wait for tonight’s EOD.",
  "jobs.history": "Run history",
  "jobs.historyHint": "Recent archive / backfill attempts",
  "jobs.historyEmpty": "No runs logged yet.",
  "jobs.colJob": "Job",
  "jobs.colWhen": "When (ET)",
  "jobs.colStatus": "Status",
  "jobs.colBars": "Bars (ok/err)",
  "jobs.colTrigger": "Trigger",
  "jobs.backend": "Storage",
  ...
  "news.subtitle":
    "Red carpet only (FF High Impact) — time, currency, actual / forecast / previous (NY).",
  ...
  "news.filterMed": "Med",
  "news.filterLow": "Low",
  "news.redCarpetOnly": "Red carpet only",
  "news.colDate": "Date",
  "news.colTime": "Time",
  "news.colCcy": "Ccy",
  ...
  "news.emptyCalendar": "No red-carpet events for this week.",
  ...
  "strategies.colTos": "TOS",
  "strategies.tosOpen": "open",
  "strategies.tosWorking": "working",
  "strategies.tosOpenHint": "Open option position in Schwab/TOS (from last Load capital).",
  "strategies.tosWorkingHint": "BUY_TO_OPEN submitted — waiting for FILL. Check TOS → Orders.",
  "strategies.openCancelled":
    "Open not sent — the confirm dialog was cancelled. Click Open again and press OK.",
  ...
  "strategies.openNeedRth":
    "Cash session is closed (9:30–4:00 ET). Do not send Open after hours — Schwab will throttle. Try after tomorrow's open.",
  ...
  "strategies.openOkTpPending":
    "Buy still working or not filled yet. When it FILLS, use Positions → TP 10/20/35/50/100.",
  "strategies.openTpFail":
  ...
  "positions.confirmCloseAll":
    "Place live MARKET close for all {n} open positions? Same as Close now on each row.",
...
const es: Dict = {
  ...
  "jobs.title": "Jobs programados",
  "jobs.hint": "Archivo de velas en Dynamo — estado, historial y corridas manuales.",
  "jobs.blurb":
    "EOD nocturno rellena gaps (15m · 1h · 4h · 1m). Backfill baja el máximo de Yahoo (~59d de 15m). El archivo crece cada noche — el Analyzer lee Dynamo.",
  "jobs.scheduleTitle": "Horarios",
  "jobs.scheduleEod":
    "EOD (auto): cada noche a las 02:15 UTC ≈ 22:15 ET en staging SAM. En local no hay cron — usa “Correr EOD ahora”.",
  "jobs.scheduleBackfill":
    "Backfill: solo manual (botón). Tope Yahoo (~59 días de 15m).",
  "jobs.runEod": "Correr EOD ahora",
  "jobs.runBackfill": "Backfill (máx Yahoo)",
  "jobs.refresh": "Refrescar",
  "jobs.runningEod": "Corriendo archivo EOD…",
  "jobs.runningBackfill": "Corriendo backfill Yahoo (puede tardar unos minutos)…",
  "jobs.done": "Listo",
  "jobs.acceptedBg": "Arrancó en background — refresca en 1–2 minutos.",
  "jobs.loading": "Cargando…",
  "jobs.scheduled": "Tarjetas de jobs",
  "jobs.scheduledHint": "Última corrida por job · recordatorio de schedule",
  "jobs.scheduleLabel": "Horario",
  "jobs.scheduleEt": "ET",
  "jobs.scheduleUtc": "UTC",
  "jobs.lastRun": "Última",
  "jobs.neverRun": "Aún no ha corrido — usa Backfill o espera el EOD de esta noche.",
  "jobs.history": "Historial",
  "jobs.historyHint": "Intentos recientes de archive / backfill",
  "jobs.historyEmpty": "Sin corridas todavía.",
  "jobs.colJob": "Job",
  "jobs.colWhen": "Cuándo (ET)",
  "jobs.colStatus": "Estado",
  "jobs.colBars": "Velas (ok/err)",
  "jobs.colTrigger": "Trigger",
  "jobs.backend": "Storage",
  ...
  "news.subtitle":
    "Solo red carpet (FF High Impact) — hora, divisa, actual / forecast / previous (NY).",
  ...
  "news.filterLow": "Bajo",
  "news.redCarpetOnly": "Solo red carpet",
  "news.colDate": "Fecha",
  "news.colTime": "Hora",
  "news.colCcy": "Divisa",
  ...
  "news.emptyCalendar": "Sin eventos red carpet esta semana.",
  ...
  "strategies.tosOpen": "open",
  "strategies.tosWorking": "working",
  "strategies.tosOpenHint": "Posición de opciones abierta en Schwab/TOS (del último Cargar capital).",
  "strategies.tosWorkingHint": "BUY_TO_OPEN enviado — esperando FILL. Mira TOS → Orders.",
  "strategies.openCancelled":
    "Open no enviado — cancelaste el confirm. Pulsa Open otra vez y OK.",
  ...
  "strategies.openNeedRth":
    "La sesión cash está cerrada (9:30–4:00 ET). No envíes Open fuera de horario — Schwab se satura. Prueba mañana tras la apertura.",
  "strategies.openWaitSync":
  ...
  "strategies.openOkTpPending":
    "La compra sigue working o no ha llenado. Cuando haga FILL, usa Posiciones → TP 10/20/35/50/100.",
  "strategies.openTpFail":
  ...
  "positions.confirmCloseAll":
    "¿Enviar MARKET de cierre live para las {n} posiciones abiertas? Igual que Cerrar ahora en cada fila.",
