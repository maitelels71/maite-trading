...
The futures desk scans like options: candles only. Universe: **MNQ · MES · 6E · 6A · 6B · MGC** via Yahoo (`MNQ=F`, `MES=F`, `6E=F`, `6A=F`, `6B=F`, `MGC=F`). Delayed ~10–15 minutes; no API key. Tradovate / MFF is for execution only — not required for Analyzer or ML01.